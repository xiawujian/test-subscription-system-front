  ...
  <div>
    <el-card>
      <el-form :model="creatForm" :rules="rules" ref="registerForm" label-width="100px" class="demo-ruleForm">
        <el-form-item label="书名" prop="name" style="width: 35%;text-align: center">
          <el-input v-model="creatForm.name"></el-input>
        </el-form-item>
        <el-form-item label="单价" prop="price" style="width: 50%;text-align: center">
          <el-input type="password" v-model="creatForm.price" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="作者" prop="authorName" style="width: 50%;text-align: center">
          <el-input type="password" v-model="creatForm.authorName" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="出版社" prop="publisher" style="width: 50%;text-align: center">
